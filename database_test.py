...
'''
        if subb == '':
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\sheri\Desktop\LambtonCollege\AML 2404 AI and ML Lab\Attendace_management_system-master\Attendance\Manually Attendance\"')
    ...
    SUB = tk.Label(sb, text="Enter Subject", width=15, height=2, fg="black", bg="snow",
                         font=('times', 15, ' bold '))
    ...
    selection_option = tk.StringVar(sb)
    selection_option.set(options[0])

    tx = tk.Entry(sb, width=20, textvariable=selection_option, bg="snow", fg="black", font=('times', 23, ' bold '))
    tx.place(x=250, y=105)
    option_menu = tk.OptionMenu(sb, selection_option, *options)
    option_menu.config(width=20, font=("times", 23, "bold"), bg="snow", fg="black")
    option_menu.pack()

    fill_a = tk.Button(sb, text="Fill Attendance", fg="black", command=fill_attendance, bg="snow", width=20,height=2, activebackground="Red", font=('times', 15, ' bold '))
    fill_a.place(x=250, y=160)

    #fill_manual_attendance = tk.Button(sb, text="Fill Attendance", fg="black", command=fill_attendance, bg="snow", width=20,height=2, activebackground="Red", font=('times', 15, ' bold '))
    #fill_manual_attendance.place(x=450, y=160)
    sb.mainloop()
...
def person_present():
    ...
    Button(sc1, text='OK', command=del_sc1, fg="black", bg="snow", width=9, height=1, activebackground="Red",
           font=('times', 15, ' bold ')).place(x=90, y=50)
        ...
        try:
            ...
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite(
                        "TrainingImage/" + person_name + "." + Enrollment + "/" + Name + "." + Enrollment + '.' + str(
                            sampleNum) + ".jpg",
                        gray[y:y + h, x:x + w])
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\sheri\Desktop\LambtonCollege\AML 2404 AI and ML Lab\Attendace_management_system-master\Attendance\"')

    attf = tk.Button(windo, text="Check Sheets", command=Attf, fg="black", bg="snow", width=12, height=1,
                     activebackground="Red", font=('times', 14, ' bold '))
    attf.place(x=430, y=255)

    sub = tk.Label(windo, text="Choose Subject", width=15, height=2, fg="black", bg="snow",
                   font=('times', 15, ' bold '))
    sub.place(x=30, y=100)
    ...
    fill_a = tk.Button(windo, text="Fill Attendance", fg="black", command=Fillattendances, bg="snow", width=20,
                       height=2,
                       activebackground="Red", font=('times', 15, ' bold '))
    fill_a.place(x=250, y=160)
    windo.mainloop()
...
lbl = tk.Label(window, text="Enter Enrollment ID", width=20, height=2, fg="black", bg="snow",
               font=('times', 15, ' bold '))
...
clearButton = tk.Button(window, text="Clear", command=clear, fg="black", bg="snow", width=10, height=1,
                        activebackground="Black", font=('times', 15, 'bold'))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear", command=clear1, fg="black", bg="snow", width=10, height=1,
                         activebackground="Black", font=('times', 15, ' bold '))
clearButton1.place(x=950, y=310)

AP = tk.Button(window, text="Check Register students", command=admin_panel, fg="black", bg="snow", width=19, height=1,
               activebackground="Black", font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="Take Images", command=take_img, fg="black", bg="snow", width=20, height=3,
                    activebackground="Black", font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images", fg="black", command=trainimg, bg="snow", width=20, height=3,
                     activebackground="Black", font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendance", fg="black", command=subjectchoose, bg="snow", width=20, height=3,
               activebackground="Black", font=('times', 15, ' bold '))
FA.place(x=690, y=500)

quitWindow = tk.Button(window, text="Manually Fill Attendance", command=manually_fill, fg="black", bg="snow", width=20,
                       height=3, activebackground="Black", font=('times', 15, ' bold '))
